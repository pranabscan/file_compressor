...
//assign the huffman codes to the present charecter
...
//return binary value in form of string
...
//reconstruction of a path of huffman tree to decode file
...
void huffman::createTree() {
    ...
    Node *left, *right;
    priority_queue <Node*, vector<Node*>, Compare> tempPQ(minHeap); // to get the minimum frequency value at first
    while (tempPQ.size()>0)
    {
        left = tempPQ.top();
        tempPQ.pop();
